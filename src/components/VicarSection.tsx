...
const VicarSection = () => {
  ...
  return (
    <section id="vicars" className="py-8 bg-church-cream">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            {currentVicars.map((leader, idx) => (
              ...
              >
                ...
                <h4 className="text-xl font-bold text-church-navy">
                  {leader.name}
                </h4>
                <p className="mt-4 text-gray-600 italic">“{leader.quote}”</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-2xl font-semibold text-church-navy mb-8 text-center">
              Past Vicars
            </h3>
                ...
                {pastVicars.map((vicar, idx) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span className="font-medium text-church-navy group-hover:text-church-gold transition-colors">
                        {vicar.name}
                      </span>
